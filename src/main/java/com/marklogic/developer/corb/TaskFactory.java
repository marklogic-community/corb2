...
public class TaskFactory {
    ...
    public Task newProcessTask(String[] uris, boolean failOnError) {
        ...
        if (null != options.getProcessModule()
                && (null == uris || uris.length == 0 || null == manager.getContentSourceManager())) {
    ...
    public Task newPreBatchTask() {
        ...
        if (null != options.getPreBatchModule() && null == manager.getContentSourceManager()) {
    ...
    public Task newPostBatchTask() {
        ...
        if (null != options.getPostBatchModule() && null == manager.getContentSourceManager()) {
            throw new NullPointerException(EXCEPTION_MSG_NULL_CONTENT);
        }
        try {
    ...
    public Task newInitTask() {
        ...
        if (null != options.getInitModule() && null == manager.getContentSourceManager()) {
            throw new NullPointerException(EXCEPTION_MSG_NULL_CONTENT);
        }
        try {
    ...
    private void setupTask(Task task, String moduleType, String module, String[] uris, boolean failOnError) {
        ...
        task.setContentSourceManager(manager.getContentSourceManager());
