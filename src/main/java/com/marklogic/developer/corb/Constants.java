...
/**
 * Defines varioius options that are used to configure Corb. 
 * @author bbandlam
 *
 */
public abstract class Constants {    
    ...
    /**
     * Used if {@value #XCC_CONNECTION_URI} is not specified. If not specified, uses the default 'xcc' as protocol
     */
