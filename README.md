...
**<a name="CONTENT-SOURCE-RENEW"></a>CONTENT-SOURCE-RENEW** | Boolean value indicating whether to create a new ContentSource when connection errors are encountered. This can help transparently deal with proxies that have dynamic pools of IP addresses. Default is `true`
